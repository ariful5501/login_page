                ...
                <div class="bg-gray-500 p-8 rounded shadow-md w-96">
                    ...
                    <form action="signup.php" method="POST">
                        ...
                        <div class="mb-4 flex items-center">
                            ...
                            <label for="terms" class="text-white">I accept the <a href="#" class="text-yellow-400 underline underline-offset-1 ">
                                terms
                            </a> and 
                        ...
                        <div class="mb-4">
                            <button type="submit" class="w-full bg-yellow-500 text-white py-2 rounded-md hover:bg-yellow-600">Sign Up</button>
                        </div>
                    </form>
                    <hr class="mt-4">
